...
class TraceMap {
   ...
   */ async visit(specifier, opts, parentUrl = this.baseUrl.href, seen = new Set()) {
        ...
        this.log("tracemap/visit", `Attempting to resolve ${specifier} to a module from ${parentUrl}, toplevel=${opts.toplevel}, mode=${opts.installOpts.mode}`);
        const resolved = await this.resolve(specifier, parentUrl, opts.installOpts, opts.toplevel);
    ...
    async add(name, target, freeze, latest) {
        await this.installer.installTarget(name, target, null, {
            mode: "new",
            freeze,
            latest
        }, null, this.mapUrl.href);
    }
    /**
