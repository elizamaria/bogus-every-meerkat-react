...
export declare class Generator {
     ...
     * ```
     */
    constructor({ baseUrl, mapUrl, rootUrl, inputMap, env, defaultProvider, defaultRegistry, customProviders, providers, resolutions, cache, ignore, freeze, latest, ipfsAPI, commonJS, }?: GeneratorOptions);
    /**
     ...
     *
     */
    htmlGenerate(html: string, { mapUrl, rootUrl, preload, integrity, whitespace, esModuleShims, comment, }?: {
        mapUrl?: string | URL;
