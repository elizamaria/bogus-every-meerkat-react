import { type InstallerOptions, InstallTarget, InstallOptions } from "../install/installer.js";
...
export default class TraceMap {
    ...
    add(name: string, target: InstallTarget, freeze?: boolean, latest?: boolean): Promise<void>;
    /**
     * @returns `resolved` - either a URL `string` pointing to the module or `null` if the specifier should be ignored.
     */
    resolve(specifier: string, parentUrl: string, installOpts: InstallOptions, toplevel: boolean): Promise<string>;
